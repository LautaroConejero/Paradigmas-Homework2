...
Numero* Num_complejo::suma(Num_complejo* n_C) {
    Num_complejo* n = dynamic_cast<Num_complejo*>(n_C);
    float real = this->valor + n->valor;
    if (n->imaginario == 0){
...
Numero* Num_complejo::resta(Num_complejo* n_C) {
    Num_complejo* n = dynamic_cast<Num_complejo*>(n_C);
...
Numero* Num_complejo::multiplicacion(Num_complejo* n_C) {
    Num_complejo* n = dynamic_cast<Num_complejo*>(n_C);
    if (n->imaginario == 0){
        float real = this->valor * n_C->valor;
...
void operaciones(vector<Numero*>& numeros_activos){
    ...
    numeros_seleccionados.push_back(temp);
